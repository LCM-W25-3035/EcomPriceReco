...
Original file is located at
    https://colab.research.google.com/drive/1nZEZ9MyuT4tiXphQkcrC4-Bg7lh4B8aF
"""

#source - chat gpt
#prompt - integrate code 1 and code 2 to extract the price of the products which is instock only.
...
def append_to_csv(data, filename="amazon_data.csv"):
