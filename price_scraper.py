#fisrt prompt:Script that tracks product prices over time from a CSV file.
#second prompt: I'm getting a ValueError: could not convert string to float when processing prices—how can I fix this in the extract_numeric_price function?
