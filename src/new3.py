...
#         # This needs to be adjusted based on the actual features your model was trained on
#         features = {}
        
#         # Convert categorical features using label encoders
#         # Example: if you have 'main_category' and 'sub_category' as categorical features
#         categorical_features = ['main_category', 'sub_category']
#         for feature in categorical_features:
#             if feature in product and feature in encoders:
#                 features[feature] = encoders[feature].transform([product[feature]])[0]
#             else:
#                 # Use a default value if feature or encoder not available
#                 features[feature] = 0
...
#         # Adjust this based on the order of features your model expects
#         X = np.array([
#             features.get('ratings', 0),
#             features.get('no_of_ratings', 0),
#             features.get('main_category', 0),
#             features.get('sub_category', 0)
#         ]).reshape(1, -1)
